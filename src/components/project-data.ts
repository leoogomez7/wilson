...
export const casaProjects: Project[] = [
  {
    ...
    meta: { es: "Vivienda Unifamiliar - 2025", en: "Single-family Home - 2025", pt: "Casa Unifamiliar - 2025" },
    ...
    description: {
      ...
      en: "The intervention redefines the home’s image through a composition of pure planes and contemporary materials, giving it a renewed identity and a stronger urban presence. The proposal improves the functionality and privacy of the whole, incorporating a metal enclosure and a restrained material palette that bring unity, durability, and character.",
      pt: "A intervenção redefine a imagem da residência por meio de uma composição de planos puros e uma materialidade contemporânea, conferindo-lhe uma identidade renovada e uma presença urbana mais forte. A proposta melhora a funcionalidade e a privacidade do conjunto, incorporando um fechamento metálico e uma paleta de materiais sóbria que traz unidade, durabilidade e caráter.",
    },
    category: "reformas",
    origin: "casas",
    gallery: [
