      ...
      >
        ...
        >
          <button
            ...
            onClick={() => setExpandedPlanIndex(null)}
            aria-label={t.projects.modal.close}
            className="absolute top-4 right-4 z-20 text-[10px] uppercase tracking-[0.3em] bg-white px-4 py-2 border border-brand-black whitespace-nowrap"
          >
            {t.projects.modal.close}
          </button>
          <div className="absolute inset-y-0 left-0 right-0 z-0 flex items-center justify-between px-4 md:px-6">
            <button
              type="button"
              ...
              className="inline-flex items-center justify-center h-11 w-11 rounded-full border border-white bg-white/90 text-brand-black transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-50"
            >
